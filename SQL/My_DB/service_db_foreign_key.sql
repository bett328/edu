...
-- Добавляю имя пользователя в таблицу
ALTER TABLE users
ADD username VARCHAR(15) NOT NULL DEFAULT 'USER';

-- Добавляю поле для ссылки на таблицу
ALTER TABLE orders
ADD user_id INT;

-- Добавляю ссылку на таблицу 
ALTER TABLE orders
...
ALTER TABLE orders
ADD CONSTRAINT orders_users_fk -- название ограничения
